...
func _ready() -> void:
	...
	EventHub.actorDestroyed.connect(game_over_if_player_dead)
...
func game_over_if_player_dead(actor:Node2D) -> void:
	print_debug("IN GAME OVER")
	if actor is HostCharacter:
